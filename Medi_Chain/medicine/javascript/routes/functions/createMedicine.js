...
async function main(key,id, name,company, pDate, expDate, cStage,img1) {
    try {
       ...
       // await contract.submitTransaction('createMedicine', 'm1','3', 'Napa', 'ACI', '12-12-18', '31-12-19','ACII')
        ...
        await contract.submitTransaction('createMedicine',key,id, name,company, pDate, expDate, cStage,img1);
