...
if [ "$CC_SRC_LANGUAGE" = "go" -o "$CC_SRC_LANGUAGE" = "golang"  ]; then
  ...
  CC_SRC_PATH=github.com/chaincode/medicine/go
	...
	CC_SRC_PATH=/opt/gopath/src/github.com/chaincode/medicine/javascript
elif [ "$CC_SRC_LANGUAGE" = "typescript" ]; then
	CC_RUNTIME_LANGUAGE=node # chaincode runtime language is node.js
	CC_SRC_PATH=/opt/gopath/src/github.com/chaincode/medicine/typescript
	echo Compiling TypeScript code into JavaScript ...
	pushd ../chaincode/medicine/typescript
	npm install
	npm run build
	popd
